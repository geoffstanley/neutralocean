...
def _process_args(
    ...
    eos, eos_s_t = _process_eos(eos, eos_s_t)
    S, T, P = _process_casts(S, T, P, vert_dim)
    Sppc, Tppc = _interp_casts(S, T, P, interp_fn, Sppc, Tppc)
    n_good = _process_n_good(S, n_good)
    return S, T, P, Sppc, Tppc, n_good, wrap, eos, eos_s_t
