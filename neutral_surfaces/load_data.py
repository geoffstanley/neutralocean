...
def load_OCCA(OCCA_dir, ts=0):
    ...
    T = np.moveaxis(T, (0,1,2), (2,1,0)) # Move vertical axis to end.  (lon, lat, depth)
    ...
    S = np.moveaxis(S, (0,1,2), (2,1,0)) # Move vertical axis to end.  (lon, lat, depth)
    ...
    P = np.moveaxis(P, (0,1,2), (2,1,0)) # Move vertical axis to end.  (lon, lat, depth)
